#!/usr/bin/env python
# Created by "Thieu" at 23:32, 13/08/2024 ----------%                                                                               
...
for idx_model, my_model in enumerate(Config.LIST_MODELS):
    ...
    for idx_trial, seed in enumerate(Config.LIST_SEEDS):
        ...
        model = InaRbfTuner(problem_type="classification", bounds=Config.PROBLEM_BOUNDS, cv=2, scoring=Config.SCORING_LOSS,
